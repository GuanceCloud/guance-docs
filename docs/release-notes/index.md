...
智能巡检事件详情页新增 “基础属性”、“历史记录”、“关联事件” 等通用页面，另外应用性能检测新增  “异常链路”、“日志” 等页面。

![](img/13.monitor_1.png)
...
若监控器配置了告警，则关联事件详情页新增 “告警通知” 页面。

- 若设置了静默管理，在静默管理期间不会发送告警事件给到通知对象，在事件详情页的 “告警通知” 页面，该告警通知被标注为 ”通知未发送“。
- 若监控器设置了告警沉默，在告警沉默期间不会发送相同的告警事件给到通知对象，在事件详情页的 “告警通知” 页面，该告警通知被标注为 ”通知未发送“。
