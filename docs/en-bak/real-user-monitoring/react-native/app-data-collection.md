...
| `service` | string | Optional,The name of the business or service to which it belongs. Defaults:<br/>`df_rum_ios`<br/>`df_rum_android` |
...
| **Fields**        | **Type** | **Description**                                        |
| :-------------- | :------- | :---------------------------------------------- |
| <del>`view_id`</del> | string   | <del>Unique ID for each page view.</del>           |
| <del>`view_referrer`</del> | string   | <del>The URL of the previous web page from which a link to the currently requested page was followed.</del>                 |
| <del>`view_name`</del> | string   | <del>View name.</del>                             |
