...
配置 Datakit  [[Mysql 数据采集](/datakit/mysql/)] 和 [[Nginx 数据采集](/datakit/nginx/)]，点击主机 `集成运行情况 `的 
...
#### 日志
配置 Datakit  [[Mysql 数据采集](/datakit/mysql/)] 和 [[Nginx 数据采集](/datakit/nginx/)] 中的日志配置，或者开启自定义日志配置 [Tailf 数据采集]，创建完成可以看到日志列表
