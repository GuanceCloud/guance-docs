...
登录『[观测云](https://console.guance.com/)』，点击『管理』模块，在基本设置界面找到 Token，点击后面的复制图标。

![1643275020(1).png](../images/ingress-crd/1.png)

#### 1.2 下载 DataKit 部署文件

登录『[观测云](https://console.guance.com/)』，点击『集成』模块，再点击左上角『DataKit』，选择『Kubernetes』，下载 datakit.yaml 文件。
