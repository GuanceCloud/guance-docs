...
- 接入（集成）最佳实践
    - [Minio 可观测最佳实践](./integrations/minio.md)。
...
### 更新记录
- 云原生
    - [使用 Rancher 部署和管理 Datakit，快速构建 Kubernetes 生态的可观测](./cloud-native/rancher-datakit.md)，<font color="red" > 增加 ingressgateway、egressgateway 指标采集，更新 container.conf 配置。</font>
    ...
    - [基于阿里云 ASM 实现微服务可观测最佳实践](./cloud-native/asm.md)，<font color="red" > 增加 istiod、ingressgateway、egressgateway 指标采集。</font>
- 日志
    - [Pod 日志采集最佳实践](./logs/pod-log.md)，<font color="red" > Logfwd 端口增加备注。</font>
    - [K8s 日志采集之 logback socket 最佳实践](./logs/k8s-logback-socket.md)，<font color="red" > 更新 container.conf 配置。</font>
    - [Kubernetes 集群中日志采集的几种玩法](./logs/k8s-logs.md)，<font color="red" > 更新 container.conf 配置。</font>
...
- 云原生
    ...
    - [基于阿里云 ASM 实现微服务可观测最佳实践](./cloud-native/asm.md)，<font color="red" > DataKit 升级到 1.4.0。</font>
...
- APM
    ...
    - [基于观测云，使用 SkyWalking 实现 RUM、APM 和日志联动分析](./apm/skywalking-apm-rum-log.md)
...
- 云原生
    - [使用 Rancher 部署和管理 Datakit，快速构建 Kubernetes 生态的可观测](./cloud-native/rancher-datakit.md)，<font color="red" >DataKit 升级到 1.4.0，默认安装 metrics-server。</font>
## (2022/05/20)
### 新增最佳实践

- 云原生
    - [使用 Rancher 部署和管理 Datakit，快速构建 Kubernetes 生态的可观测](./cloud-native/rancher-datakit.md)
### 更新记录

- APM
    - [web 应用监控（RUM）最佳实践](./apm/web.md)，<font color="red" > 修改同步载入使用的 JS。</font>
- 云原生
    ...
    - [基于阿里云 ASM 实现微服务可观测最佳实践 ](./cloud-native/asm.md)，<font color="red" > 修改 RUM 同步载入使用的 JS。</font>
...
- 日志最佳实践
    - [Pod 日志采集最佳实践](./logs/pod-log.md)，<font color="red" >更新logfwd采集器版本，增加logfwd 的 tag使用方式</font>
...
- 日志最佳实践
    - [Pod 日志采集最佳实践](./logs/pod-log.md)，<font color="red" >Logfwd 方案中增加 ConfigMap 如何使用</font>
...
- 微服务可观测最佳实践
    ...
    - [从 0 到 1 利用观测云构建 Spring cloud 服务的可观测性](./apm/spring-cloud-sample.md)，<font color="red" >调整了部分产品名词叫法跟观测云产品保持一致</font>
- 日志最佳实践
    - [Pod 日志采集最佳实践](./logs/pod-log.md) ，<font color="red" >调整方案循序，将热门使用方案置顶</font>
...
- 接入（集成）最佳实践
    - [JVM 可观测最佳实践](./integrations/jvm.md)，<font color="red" >修改 datakit 版本为 datakit:1.2.1，container.conf 使用最新配置</font>
- 微服务可观测最佳实践
