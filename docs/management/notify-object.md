...
“观测云”支持您通过「管理」-「通知对象管理」，设置告警事件的通知对象，包括钉钉机器人、企业微信机器人、飞书机器人、Webhook自定义、邮件组和短信组。如何设置告警通知可参考文档 [告警设置](../monitoring/alert-setting.md) 。
...
**注意：飞书机器人告警通知是每分钟合并了发送，并不是产生后立刻发送，会存在约一分钟的延迟。**<br />![](img/15.inform_feishu_1.png)
