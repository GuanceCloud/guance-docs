...
点击任意事件，即可查看该事件详情，包括基础属性、告警通知、状态&趋势、历史记录、关联事件和关联SLO。更多详情可参考文档 [事件详情页](event-details.md) 。

### 聚合事件详情页

在事件列表中，选择分析维度可对相似事件进行聚合统计，点击聚合事件，即可查看该聚合事件对应的基础属性、状态&趋势、和关联事件。更多详情可参考文档 [事件详情页](event-details.md) 。
