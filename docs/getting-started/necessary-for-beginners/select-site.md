...
观测云支持免费开始，您可以根据您使用资源的情况选择任意站点。需要注意的是不同站点的账号和数据相互独立，无法互相共享和迁移数据。
...
您可以在观测云登录地址，选择您注册的站点进行登录，若还未注册账号，可点击“点此注册”进行账号注册，更多可参考文档 [账号管理](../../management/account-management.md) 。
