...
- 异常详情：智能检测的磁盘指标异常图表趋势
  ...
  - 预测虚线：表示提前预测的趋势线
- 异常分析：智能检测的异常磁盘及挂载点，帮助用户快速定位磁盘异常的原因；点击主机，支持复制和查看相关日志、容器、进程、安全巡检、链路、用户访问监测、可用性监测以及 CI 等

![](../img/4.bot_obs_12.png)

#### 告警通知

显示通知对象类型、通知对象名称、告警策略、以及通知是否发送成功等信息。

![](../img/4.bot_obs_13.png)

#### 历史记录

支持查看检测对象主机、异常/恢复时间和持续时长。

![](../img/4.bot_obs_14.png)

#### 关联事件

支持通过筛选字段和所选取的时间组件信息，查看关联事件。

![](../img/4.bot_obs_15.png)

#### 内置视图

支持手动添加 `tags` 关联的内置视图结合智能巡检进行分析。关于如何配置内置视图可参考文档 [绑定内置视图](../../scene/built-in-view/bind-view.md) 。
