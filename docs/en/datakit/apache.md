...
Apache collector can collect the number of requests, connections and others from Apache services, and collect metrics to Guance Cloud to help monitor and analyze various abnormal situations of Apache.
