...
=== "Host Installation"
    ...
    Go into the `conf.d/prom` directory under the DataKit installation directory, copy `prom_remote_write.conf.sample` and name it `prom_remote_write.conf`. Examples are as follows:
