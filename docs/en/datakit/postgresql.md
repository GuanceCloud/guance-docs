...
[[inputs.postgresql]]
  ...
  ## When configuring the collected database, all databases will be collected by default. When setting ignored_databases and databases at the same time, databases will be ignored
  # ignored_databases = ["db1"]
  # databases = ["db1"]

  ## Set the server Tag, which is generated based on the server address by default
  # outputaddress = "db01"
