...
Datakit supports writing the collected index data into M3db, which can be configured to the specified database in the form of configuration file and environment variable.
...
## Open Sink-m3db on Datakit {#enable}
