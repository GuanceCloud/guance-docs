...
=== "Windows 32 bit"
    ...
    - [`Datakit`](https://static.guance.com/datakit/datakit-windows-386-1.66.2.tar.gz){:target="_blank"}
    - [`Datakit`](https://static.guance.com/datakit/datakit_lite-windows-386-1.66.2.tar.gz){:target="_blank"}
...
=== "Windows 64 bit"
    ...
    - [`Datakit`](https://static.guance.com/datakit/datakit-windows-amd64-1.66.2.tar.gz){:target="_blank"}
    - [`Datakit`](https://static.guance.com/datakit/datakit_lite-windows-amd64-1.66.2.tar.gz){:target="_blank"}
...
=== "Linux X86 32 bit"
    ...
    - [`Datakit`](https://static.guance.com/datakit/datakit-linux-386-1.66.2.tar.gz){:target="_blank"}
    - [`Datakit`](https://static.guance.com/datakit/datakit_lite-linux-386-1.66.2.tar.gz){:target="_blank"}
...
=== "Linux X86 64 bit"
    ...
    - [`Datakit`](https://static.guance.com/datakit/datakit-linux-amd64-1.66.2.tar.gz){:target="_blank"}
    - [`Datakit`](https://static.guance.com/datakit/datakit_lite-linux-amd64-1.66.2.tar.gz){:target="_blank"}
    - [`Upgrader`](https://static.guance.com/datakit/dk_upgrader-linux-amd64.tar.gz){:target="_blank"}
    - [`APM Auto Instrumentation`](https://static.guance.com/datakit/datakit-apm-inject-linux-amd64-1.66.2.tar.gz){:target="_blank"}

=== "Linux Arm 32 bit"

    - [`Installer`](https://static.guance.com/datakit/installer-linux-arm){:target="_blank"}
    - [`Datakit`](https://static.guance.com/datakit/datakit-linux-arm-1.66.2.tar.gz){:target="_blank"}
    - [`Datakit`](https://static.guance.com/datakit/datakit_lite-linux-arm-1.66.2.tar.gz){:target="_blank"}
...
=== "Linux Arm 64 bit"
    ...
    - [`Datakit`](https://static.guance.com/datakit/datakit-linux-arm64-1.66.2.tar.gz){:target="_blank"}
    - [`Datakit`](https://static.guance.com/datakit/datakit_lite-linux-arm64-1.66.2.tar.gz){:target="_blank"}
    - [`Upgrader`](https://static.guance.com/datakit/dk_upgrader-linux-arm64.tar.gz){:target="_blank"}
    - [`APM Auto Instrumentation`](https://static.guance.com/datakit/datakit-apm-inject-linux-arm64-1.66.2.tar.gz){:target="_blank"}
<!-- markdownlint-enable -->
...
> If you are performing an offline install of the lite version of Datakit, you need to specify the installation package with a `_lite` suffix, such as `datakit_lite-linux-amd64-1.66.2.tar.gz`.
...
=== "Linux"
    ...
    ./installer-linux-amd64 --offline --dataway "https://openway.guance.com?token=<YOUR-TOKEN>" --srcs datakit-linux-amd64-1.66.2.tar.gz,dk_upgrader-linux-amd64.tar.gz,data.tar.gz
    ```
...
=== "Windows"
    ...
    ```powershell
    .\installer-windows-amd64.exe --offline --dataway "https://openway.guance.com?token=<YOUR-TOKEN>" --srcs .\datakit-windows-amd64-1.66.2.tar.gz,.\dk_upgrader-windows-amd64.tar.gz,.\data.tar.gz
    ```
<!-- markdownlint-enable -->
#### Upgrade {#simple-upgrade}

> If you are performing an offline upgrade of the lite version of Datakit, you need to specify the installation package with a `_lite` suffix, such as `datakit_lite-linux-amd64-1.66.2.tar.gz`.
...
=== "Linux"
    ...
    ```shell
    chmod +x installer-linux-amd64
    ./installer-linux-amd64 --offline --upgrade --srcs datakit-linux-amd64-1.66.2.tar.gz,data.tar.gz
    ```
...
=== "Windows"
    ...
    ```powershell
    .\installer-windows-amd64.exe --offline --upgrade --srcs .\datakit-windows-amd64-1.66.2.tar.gz,.\data.tar.gz
    ```
<!-- markdownlint-enable -->
...
wget -P /datakit https://static.guance.com/datakit/installer-linux-amd64-1.66.2
wget -P /datakit https://static.guance.com/datakit/datakit-linux-amd64-1.66.2.tar.gz
wget -P /datakit https://static.guance.com/datakit/datakit_lite-linux-amd64-1.66.2.tar.gz
wget -P /datakit https://static.guance.com/datakit/dk_upgrader-linux-amd64.tar.gz
wget -P /datakit https://static.guance.com/datakit/datakit-apm-inject-linux-amd64-1.66.2.tar.gz
...
???+ Attention
    ...
    You must append suffix **.exe** to the download link of `Installer` on Windows, for example: [*https://static.guance.com/datakit/installer-windows-386-1.66.2.exe*](https://static.guance.com/datakit/installer-windows-386-1.66.2.exe) for Windows 32bit and
    [*https://static.guance.com/datakit/installer-windows-amd64-1.66.2.exe*](https://static.guance.com/datakit/installer-windows-amd64-1.66.2.exe) for Windows 64bit.
<!-- markdownlint-enable -->
...
docker pull --platform amd64 pubrepo.guance.com/datakit/datakit:1.66.2
docker save -o datakit-amd64-1.66.2.tar pubrepo.guance.com/datakit/datakit:1.66.2
mv datakit-amd64-1.66.2.tar /home/guance

# Pull the image of the arm64 architecture and make it into an image package
docker pull --platform arm64 pubrepo.guance.com/datakit/datakit:1.66.2
docker save -o datakit-arm64-1.66.2.tar pubrepo.guance.com/datakit/datakit:1.66.2
mv datakit-arm64-1.66.2.tar /home/guance

# Check whether the image architecture is correct
docker image inspect pubrepo.guance.com/datakit/datakit:1.66.2 |grep Architecture
...
wget http://<nginx-server-ip>:8080/datakit-amd64-1.66.2.tar 
```
...
```shell
# docker 
docker load -i /k8sdata/datakit/datakit-amd64-1.66.2.tar

# containerd
ctr -n=k8s.io image import /k8sdata/datakit/datakit-amd64-1.66.2.tar
...
```shell
# docker 
docker load -i datakit-amd64-1.66.2.tar

# containerd
ctr -n=k8s.io image import datakit-amd64-1.66.2.tar
