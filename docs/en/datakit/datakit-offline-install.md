...
=== "Windows 32 bit"
    ...
    - [`Datakit`](https://static.guance.com/datakit/datakit_lite-windows-386-1.66.1.tar.gz){:target="_blank"}
...
=== "Windows 64 bit"
    ...
    - [`Datakit`](https://static.guance.com/datakit/datakit_lite-windows-amd64-1.66.1.tar.gz){:target="_blank"}
...
=== "Linux X86 32 bit"
    ...
    - [`Datakit`](https://static.guance.com/datakit/datakit_lite-linux-386-1.66.1.tar.gz){:target="_blank"}
...
=== "Linux X86 64 bit"
    ...
    - [`Datakit`](https://static.guance.com/datakit/datakit_lite-linux-amd64-1.66.1.tar.gz){:target="_blank"}
...
=== "Linux Arm 32 bit"
    ...
    - [`Datakit`](https://static.guance.com/datakit/datakit_lite-linux-arm-1.66.1.tar.gz){:target="_blank"}
...
=== "Linux Arm 64 bit"
    ...
    - [`Datakit`](https://static.guance.com/datakit/datakit_lite-linux-arm64-1.66.1.tar.gz){:target="_blank"}
...
> If you are performing an offline install of the lite version of Datakit, you need to specify the installation package with a `_lite` suffix, such as `datakit_lite-linux-amd64-1.66.1.tar.gz`.
...
> If you are performing an offline upgrade of the lite version of Datakit, you need to specify the installation package with a `_lite` suffix, such as `datakit_lite-linux-amd64-1.66.1.tar.gz`.
...
???+ Attention
    ...
    You must append suffix **.exe** to the download link of `Installer` on Windows, for example: [*https://static.guance.com/datakit/installer-windows-386-1.66.1.exe*](https://static.guance.com/datakit/installer-windows-386-1.66.1.exe) for Windows 32bit and
    [*https://static.guance.com/datakit/installer-windows-amd64-1.66.1.exe*](https://static.guance.com/datakit/installer-windows-amd64-1.66.1.exe) for Windows 64bit.
<!-- markdownlint-enable -->
