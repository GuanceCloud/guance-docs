...
???+ Attention
    ...
    You must append suffix **.exe** to the download link of `Installer` on Windows, for example: [*https://static.guance.com/datakit/installer-windows-386-1.28.1.exe*](https://static.guance.com/datakit/installer-windows-386-1.28.1.exe) for Windows 32bit and
    [*https://static.guance.com/datakit/installer-windows-amd64-1.28.1.exe*](https://static.guance.com/datakit/installer-windows-amd64-1.28.1.exe) for Windows 64bit.
<!-- markdownlint-enable -->
