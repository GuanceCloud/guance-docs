...
=== "Windows 32 bit"
    ...
    - [`DataKit`](https://static.guance.com/datakit/datakit-windows-386-1.29.1.tar.gz){:target="_blank"}
...
=== "Windows 64 bit"
    ...
    - [`DataKit`](https://static.guance.com/datakit/datakit-windows-amd64-1.29.1.tar.gz){:target="_blank"}
...
=== "Linux X86 32 bit"
    ...
    - [`DataKit`](https://static.guance.com/datakit/datakit-linux-386-1.29.1.tar.gz){:target="_blank"}
...
=== "Linux X86 64 bit"
    ...
    - [`DataKit`](https://static.guance.com/datakit/datakit-linux-amd64-1.29.1.tar.gz){:target="_blank"}
...
=== "Linux Arm 32 bit"
    ...
    - [`DataKit`](https://static.guance.com/datakit/datakit-linux-arm-1.29.1.tar.gz){:target="_blank"}
...
=== "Linux Arm 64 bit"
    ...
    - [`DataKit`](https://static.guance.com/datakit/datakit-linux-arm64-1.29.1.tar.gz){:target="_blank"}
...
=== "Linux"
    ...
    ./installer-linux-amd64 --offline --dataway "https://openway.guance.com?token=<YOUR-TOKEN>" --srcs datakit-linux-amd64-1.29.1.tar.gz,dk_upgrader-linux-amd64.tar.gz,data.tar.gz
    ```
...
=== "Windows"
    ...
    ```powershell
    .\installer-windows-amd64.exe --offline --dataway "https://openway.guance.com?token=<YOUR-TOKEN>" --srcs .\datakit-windows-amd64-1.29.1.tar.gz,.\dk_upgrader-windows-amd64.tar.gz,.\data.tar.gz
    ```
<!-- markdownlint-enable -->
...
=== "Linux"
    ...
    ```shell
    chmod +x installer-linux-amd64
    ./installer-linux-amd64 --offline --upgrade --srcs datakit-linux-amd64-1.29.1.tar.gz,data.tar.gz
    ```
...
=== "Windows"
    ...
    ```powershell
    .\installer-windows-amd64.exe --offline --upgrade --srcs .\datakit-windows-amd64-1.29.1.tar.gz,.\data.tar.gz
    ```
<!-- markdownlint-enable -->
...
wget -P /datakit https://static.guance.com/datakit/installer-linux-amd64-1.29.1
wget -P /datakit https://static.guance.com/datakit/datakit-linux-amd64-1.29.1.tar.gz
...
???+ Attention
    ...
    You must append suffix **.exe** to the download link of `Installer` on Windows, for example: [*https://static.guance.com/datakit/installer-windows-386-1.29.1.exe*](https://static.guance.com/datakit/installer-windows-386-1.29.1.exe) for Windows 32bit and
    [*https://static.guance.com/datakit/installer-windows-amd64-1.29.1.exe*](https://static.guance.com/datakit/installer-windows-amd64-1.29.1.exe) for Windows 64bit.
<!-- markdownlint-enable -->
...
docker pull --platform amd64 pubrepo.guance.com/datakit/datakit:1.29.1
docker save -o datakit-amd64-1.29.1.tar pubrepo.guance.com/datakit/datakit:1.29.1
mv datakit-amd64-1.29.1.tar /home/guance

# Pull the image of the arm64 architecture and make it into an image package
docker pull --platform arm64 pubrepo.guance.com/datakit/datakit:1.29.1
docker save -o datakit-arm64-1.29.1.tar pubrepo.guance.com/datakit/datakit:1.29.1
mv datakit-arm64-1.29.1.tar /home/guance

# Check whether the image architecture is correct
docker image inspect pubrepo.guance.com/datakit/datakit:1.29.1 |grep Architecture
...
wget http://<nginx-server-ip>:8080/datakit-amd64-1.29.1.tar 
```
...
```shell
# docker 
docker load -i /k8sdata/datakit/datakit-amd64-1.29.1.tar

# containerd
ctr -n=k8s.io image import /k8sdata/datakit/datakit-amd64-1.29.1.tar
...
```shell
# docker 
docker load -i datakit-amd64-1.29.1.tar

# containerd
ctr -n=k8s.io image import datakit-amd64-1.29.1.tar
