...
???+ Attention
    ...
    You must append suffix **.exe** to the download link of `Installer` on Windows, for example: [*https://static.guance.com/datakit/installer-windows-386-1.34.0.exe*](https://static.guance.com/datakit/installer-windows-386-1.34.0.exe) for Windows 32bit and
    [*https://static.guance.com/datakit/installer-windows-amd64-1.34.0.exe*](https://static.guance.com/datakit/installer-windows-amd64-1.34.0.exe) for Windows 64bit.
<!-- markdownlint-enable -->
