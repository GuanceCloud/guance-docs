...
=== "Host Installation"
    ...
    [[inputs.external]]
      ...
      #############################
      # Parameter description (marked * as required)
      #############################
      # *--interval       : Frequency of acquisition, minimum granularity 5m
      # *--host           : oracle instance address (ip)
      #  --port           : oracle listening port
      # *--username       : oracle username
      # *--password       : oracle password
      # *--service-name   : oracle's service name
      # *--query          : Custom query statement in the format of <sql: metricName: tags>, sql is a custom collected statement, tags is filled with tag field
