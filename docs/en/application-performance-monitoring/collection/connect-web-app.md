...
- Configure [ddtrace](../../datakit/ddtrace.md), [skywalking](../../datakit/skywalking.md), [opentelemetry](../../datakit/opentelemetry.md), [jaeger](../../datakit/jaeger.md) and [zipkin](../../datakit/zipkin.md) on the corresponding web application target server.
...
. The target server needs to use the HTTP service.

### Front End RUM Setup Steps

1. Introducing the RUM SDK into the front-end application [RUM Introducing](../../real-user-monitoring/web/app-access.md).
