...
To synchronize the monitoring data of Azure Virtual Machines resources, we install the corresponding collection script：「Guance Integration（Azure-Virtual Machine）」(ID：`guance_azure_network_public_ip_address`)
