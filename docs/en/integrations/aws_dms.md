...
To synchronize monitoring data of AWS DMS cloud resources, we install the corresponding collection script: "<<< custom_key.brand_name >>> Integration (AWS-DMS Collection)" (ID: `guance_aws_dms`)
