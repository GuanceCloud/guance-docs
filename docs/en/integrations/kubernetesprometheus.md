...
1. Finally, start Datakit and in the logs you will see content like `create prom url xxxxx for testing/prom-svc`, and on the Guance page, you will see the `prom-svc` Measurement.
