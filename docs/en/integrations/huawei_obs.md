...
| `download_bytes`                   | Total download bandwidth                                 | This metric is used to measure the size of downloaded objects per second in a statistical period. Unit: byte /s   | ≥ 0 byte/s | Bucket domain name       | 1分钟                |
| `download_bytes_extranet`          | **Extranet** download bandwidth                         | This metric is used to measure the total size of Internet download objects per second in the statistical period. Unit: byte /s | ≥ 0 byte/s | Bucket domain name       | 1 min                |
| `download_bytes_intranet`          | Intranet download bandwidth                              | This metric is used to measure the total size of downloaded objects per second within the statistical period. Unit: byte /s | ≥ 0 byte/s | Bucket domain name       | 1 min                |
...
| `upload_bytes_extranet`            | **Extranet** transmission bandwidth                      | This metric is used to measure the average size of objects transferred to the Internet per second in the statistical period. Unit: byte /s | ≥ 0 byte/s | Bucket domain name       | 1 min                |
...
| `download_traffic_extranet`        | **Extranet** download traffic                            | This metric is used to measure the total size of download objects on and off the Internet. Unit: byte         | ≥ 0 bytes  | Bucket domain name       | 1 min                |
...
| `upload_traffic_extranet`          | **Extranet** traffic                                     | This metric is used to collect the total size of objects transmitted online within and outside a period. Unit: byte      | ≥ 0 bytes  | Bucket domain name       | 1 min                |
