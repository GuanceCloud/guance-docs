...
To synchronize the monitoring data of ClickHouse cloud resources, we install the corresponding collection script：「观测云集成（阿里云-ClickHouse 社区兼容版)」(ID：`guance_aliyun_clickhouse_community`)
