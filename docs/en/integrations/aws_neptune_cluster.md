...
To synchronize monitoring data of ECS cloud resources, we install the corresponding collection script: "Guance Integration (AWS-Neptune Cluster Collection)" (ID: `guance_aws_lambda`)
