...
To synchronize the monitoring data of AWS Kinesis cloud resources, we install the corresponding collection script：「Guance Integration（**AWS-Managed Streaming for Kafka Collect**）」(ID：`guance_aws_kafka`)
