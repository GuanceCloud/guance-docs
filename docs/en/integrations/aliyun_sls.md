...
To synchronize SLS monitoring data, we install the corresponding collection script: "Guance Integration (Alibaba Cloud - Cloud Monitor)" (ID: `guance_aliyun_monitor`)
