...
### Enabling Git Deployment with Helm

Note: Enabling Git configuration management will make ConfigMap ineffective, and `default_enabled_inputs` will not have any impact.
