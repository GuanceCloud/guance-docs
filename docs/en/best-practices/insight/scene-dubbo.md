...
Log in to the 「[<<< custom_key.brand_name >>>](https://<<< custom_key.studio_main_site >>>/)」 console, go to the 「Integration」 module, click 「DataKit」 - 「Linux」, copy the installation command, and execute it on the host `172.16.0.245`. Note that the installation command contains a token, which will be used in subsequent operations.
...
Log in to the 「[<<< custom_key.brand_name >>>](https://<<< custom_key.studio_main_site >>>/)」 console, go to the 「User Access Monitoring」 module, create a new dubbo-web application, and copy the following command.
...
Log in to the 「[<<< custom_key.brand_name >>>](https://<<< custom_key.studio_main_site >>>/)」 console, go to the 「User Access Monitoring」 - 「dubbo-web」 section, where various features can be used to analyze the performance of the front-end application.
...
Log in to the 「[<<< custom_key.brand_name >>>](https://<<< custom_key.studio_main_site >>>/)」 console, go to the 「Logs」 - 「Pipelines」 section.<br/>
...
Log in to 「[<<< custom_key.brand_name >>>](https://<<< custom_key.studio_main_site >>>/)」 - 「User Access Monitoring」, click 「dubbo-web」, enter the Explorer, select 「View」 to check page call situations.<br/>
