...
| Number of log data | per million | 1.2 yuan | 1.5 yuan | 2 yuan | 2.5 yuan |
...
On the right side of the log blacklist, click **Delete** to delete the existing log filtering rules. After the filtering rules are deleted, the log data will be reported to the workspace normally.
