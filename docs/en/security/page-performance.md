...
| `view.loading_time`               | number(ns)  | The page has reached the ready state and there are no network requests or DOM changes.<br/>> See [Page Loading Time](./page-performance.md).                                                                                                             |
