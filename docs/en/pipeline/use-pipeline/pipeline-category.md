...
1. The default script of the data category set for all data under this category in Guance console.
1. The mapping relationship between data and scripts set in Guance console.
