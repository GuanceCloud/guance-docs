...
In the self-built DataFlux Func, install the "Observation Cloud Custom Inspection (APM Errors)" through the "Script Market" and follow the prompts to configure the Observation Cloud API Key to complete activation.
