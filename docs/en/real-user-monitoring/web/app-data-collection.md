...
<<< custom_key.brand_name >>>'s RUM includes six types of data:
...
| ------------------------------------------- | ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `loading_time`                              | number(ns)   | Time when the page is ready with no network requests or DOM changes, refer to [Page Loading Time](../../security/page-performance.md#loading-time)                                                                                                                   |
