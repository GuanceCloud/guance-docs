...
| fieldType | string |  | Field type<br>Example: time <br>Allow null: False <br>Allow empty string: True <br>Optional values: ['int', 'float', 'boolean', 'string', 'long'] <br> |
| fieldSource | string |  | Field source<br>Example: time <br>Allow null: False <br>Allow empty string: True <br>Optional values: ['logging', 'object', 'custom_object', 'keyevent', 'tracing', 'rum', 'security', 'network', 'billing'] <br> |
...
| coverInner | boolean |  | Whether to overwrite if the added field name is the same as a system-built-in field, true for overwrite, false for no overwrite<br>Example: True <br>Allow null: False <br> |
