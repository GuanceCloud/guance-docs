...
On the [<<< custom_key.brand_name >>> official website](https://<<< custom_key.brand_main_domain >>>/), click **[Free Registration](https://<<< custom_key.studio_main_site_auth >>>/businessRegister)**, fill in the relevant information to become a <<< custom_key.brand_name >>> user.
