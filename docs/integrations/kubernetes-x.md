...
以下所有数据采集，默认会追加名为 `host` 的全局 tag（tag 值为 DataKit 所在主机名），也可以在配置中通过 `[[inputs..tags]]` 另择 host 来命名。
    ...
    spec:
      ...
      - env:
        ...
        - name: ENV_HTTP_LISTEN
          value: 0.0.0.0:9529
        image: pubrepo.jiagouyun.com/datakit/datakit:1.4.9
  ...
  template:
    ...
    spec:
      ...
      - env:
        ...
        - name: ENV_HTTP_LISTEN
          value: 0.0.0.0:9529
        image: pubrepo.jiagouyun.com/demo/datakit-win:1.4.9
        imagePullPolicy: Always
        name: datakit-win
        ports:
        - containerPort: 9529
