...
<场景 - 新建仪表板 - 内置模板库 - Android 应用概览>
<场景 - 新建仪表板 - 内置模板库 - Android 应用错误分析>
<场景 - 新建仪表板 - 内置模板库 - Android 应用页面性能分析>
<场景 - 新建仪表板 - 内置模板库 - Android 应用资源性能分析>

## 指标详解

<[Android应用数据采集指标](../real-user-monitoring/android/app-data-collection)>
