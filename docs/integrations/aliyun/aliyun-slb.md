...
![image](../imgs/input-aliyun-slb-05.png)

2、 开启脚本市场：「管理」 - 「实验性功能」 - 「开启脚本市场模块」

![image](../imgs/input-aliyun-slb-06.png)
...
![image](../imgs/input-aliyun-slb-07.png)

4、 脚本安装完成后，可以在「脚本库」中看到所有脚本集

![image](../imgs/input-aliyun-slb-08.png)

#### 添加脚本

1、「开发」 - 「脚本库」 - 「添加脚本集」

![image](../imgs/input-aliyun-slb-09.png)

2、 点击上一步添加的「脚本集」 - 「添加脚本」

![image](../imgs/input-aliyun-slb-10.png)

3、 创建 ID 为 main 的脚本

![image](../imgs/input-aliyun-slb-11.png)
...
![image](../imgs/input-aliyun-slb-12.png)

#### 定时任务

1、 添加自动触发任务：「管理」 - 「自动触发配置」 - 「新建任务」

![image](../imgs/input-aliyun-slb-13.png)

2、「保存」 配置并 「发布」自动触发配置：在「执行函数」中添加此脚本，执行频率为 **每分钟 \* \* \* \* \***

![image](../imgs/input-aliyun-slb-14.png)

3、 指标预览

![image](../imgs/input-aliyun-slb-15.png)
...
![image](../imgs/input-aliyun-slb-16.png)

- 连接配置：DataFlux Func 无法连接 DataKit，请检查数据源配置 (Datakit 需要监听 0.0.0.0)

![image](../imgs/input-aliyun-slb-17.png)
