...
- 通过「内置视图」的绑定功能，添加查看进程对象相关的内置视图。更多配置详情，可参考[绑定内置视图](https://www.yuque.com/dataflux/doc/dns233/)。
...
- 主机/进程服务网络流量数据默认保存最近48小时，体验版默认保存最近24小时；
...
在进程列表页面，“观测云” 默认为您展示 PID、用户、主机等信息。您可以通过「显示列」向列表添加、删除显示列，便捷您的数据查看和访问。
![](img/image_9.png)
...
**注意：**绑定内置视图前，管理员需要确认所绑定内置视图（[系统视图](https://www.yuque.com/dataflux/doc/gyl9vv#b19970f7)、[用户视图](https://www.yuque.com/dataflux/doc/gyl9vv#cac5e384)）中的视图变量是否存在与该进程相关的字段，如`process_id`。更多配置详情，可参考[绑定内置视图](https://www.yuque.com/dataflux/doc/dns233/)。
