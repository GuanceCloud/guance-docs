...
您可以在 Profile 左侧快捷筛选菜单，勾选快捷筛选的字段快速筛选数据，支持自定义添加筛选字段，更多快捷筛选可参考文档 [快捷筛选](../others/explorer-search.md#quick-filter) 。
...
列表中展示的“发生时间”、“服务名”、“环境”、“版本”、“主机”、“语言”以及“持续时间”，可通过「显示列」自定义添加、编辑、删除显示列。
