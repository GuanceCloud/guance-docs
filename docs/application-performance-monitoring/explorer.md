...
- 搜索支持多个关键词搜索，采用 AND 逻辑，输入的关键词越多数据匹配的范围越精准，使用空格或者逗号隔开即可。更多搜索与筛选可参考文档 [查看器检索](../others/explorer-search.md) 。
...
列表中展示的“发生时间”、“链路ID”、“服务名”、“资源名”以及“持续时间”，可通过「显示列」自定义添加、编辑、删除、拖动显示列。
