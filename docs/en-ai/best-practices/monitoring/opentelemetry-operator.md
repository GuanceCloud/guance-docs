...
[Kubernetes DataKit Installation](https://docs.guance.com/datakit/datakit-daemonset-deploy/)
...
data:
    opentelemetry.conf: |-
        [[inputs.opentelemetry]]
            ...
            trace_enable = true
            metric_enable = true
            addr = "0.0.0.0:4319" # default 4317
...
### Viewing Application Log Information
