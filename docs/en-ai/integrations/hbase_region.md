...
dashboard :
  - desc  : 'Built-in View for HBase Region'
...
Add the following to the startup parameters of HBase Region:
...
- urls: The `jmx-exporter` metrics URL, fill in the exposed metrics URL of the corresponding component.
...
HBase Region metrics are located under the Hadoop metrics set. Here we introduce the relevant metrics for HBase Region.

| Metrics | Description | Unit |
|:--------|:------------|:-----|
|`hadoop_hbase_regionCount` | Number of regions hosted by the region server | count |
|`hadoop_hbase_storeFileCount` | Number of store files on disk managed by the region server | count |
...
|`hadoop_hbase_numActiveHandler` | Number of active RPC handlers serving requests | count |
...
|`hadoop_hbase_blockCacheExpressHitPercent` | Percentage of cache requests that hit the cache | count |
|`hadoop_hbase_percentFilesLocal` | Percentage of store file data that can be read from local DataNodes | count |
...
|`hadoop_hbase_majorcompactiontime_max` | Maximum time for major compaction | ms |
|`hadoop_hbase_majorcompactiontime_mean` | Average time for major compaction | ms |
|`hadoop_hbase_majorcompactiontime_median` | Median time for major compaction | ms |
|`hadoop_hbase_majorcompactiontime_min` | Minimum time for major compaction | ms |
|`hadoop_hbase_maxstorefileage` | Maximum age of store files | count |
|`hadoop_hbase_memheapcommittedm` | Committed heap memory | MB |
|`hadoop_hbase_memheapmaxm` | Maximum heap memory | MB |
|`hadoop_hbase_memheapusedm` | Used heap memory | MB |
|`hadoop_hbase_memmaxm` | Maximum total memory | MB |
|`hadoop_hbase_memnonheapcommittedm` | Committed non-heap memory | MB |
|`hadoop_hbase_memnonheapmaxm` | Maximum non-heap memory | MB |
|`hadoop_hbase_memnonheapusedm` | Used non-heap memory | MB |
|`hadoop_hbase_mobfilecachehitpercent` | MOB file cache hit ratio percentage | % |
|`hadoop_hbase_mutationswithoutwalcount` | Number of mutations without write-ahead log (WAL) | count |
|`hadoop_hbase_averageregionsize` | Average region size | MB |
...
|`hadoop_hbase_blockcachecounthitpercent` | Block cache hit ratio percentage | % |
|`hadoop_hbase_blockcachedatahitcount` | Number of data block cache hits | count |
|`hadoop_hbase_blockcacheevictioncount` | Number of block cache evictions | count |
|`hadoop_hbase_blockcachehitcount` | Number of block cache hits | count |
|`hadoop_hbase_blockcachemisscount` | Number of block cache misses | count |
|`hadoop_hbase_compactioninputfilecount_99th_percentile` | 99th percentile value of the number of input files for compaction | count |
|`hadoop_hbase_compactionoutputfilecount_99th_percentile` | 99th percentile value of the number of output files for compaction | count |
|`hadoop_hbase_compactiontime_99th_percentile` | 99th percentile value of compaction time | ms |
...
|`hadoop_hbase_flushmemstoresize_99th_percentile` | 99th percentile value of the size of flushed MemStore | byte |
|`hadoop_hbase_flushoutputsize_99th_percentile` | 99th percentile value of the size of flushed output | byte |
...
|`hadoop_hbase_zerocopybytesread` | Number of zero-copy bytes read | byte |
</input_content>
</input>
</input>
</input>
