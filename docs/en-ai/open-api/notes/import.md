...
## Overview
Export the note specified by `notes_uuid` as a template structure. You can set the note name in the exported template based on conditions.
...
| Parameter Name    | Type   | Required | Description                          |
|:--------------|:-----|:-------|:--------------------------------------|
| templateInfo  | json |        | Note template<br>Example: {} <br>Allow empty: False |
