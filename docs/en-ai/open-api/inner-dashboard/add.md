...
| specifyDashboardUUID | string | No | Specify the UUID of the new dashboard, must start with `dsbd_custom_` followed by 32 lowercase letters or digits<br>Example: dsbd_custom_xxxx32 <br>Allow null: False <br>Allow empty string: False <br>$matchRegExp: ^dsbd_custom_[a-z0-9]{32}$ <br> |
