...
| exterStoreName | string | Y | External storage name that maps to the name (SLS type corresponds to StoreName, Volcano Cloud's TLS corresponds to topic_name)<br>Can be empty: False <br> |
...
| isPublicNetworkAccess | boolean |  | Whether to access via public network, effective when storeType is sls, default is False (added in iteration on 2024-07-10)<br>Can be empty: True <br> |
