...
| idpData           | string |         | XML document content (required for SAML type)<br>Example:  <br>Allow null: False <br> |
...
| tokenHoldTime     | integer|         | Token hold duration, in seconds, default value 14400<br>Allow null: False <br>Allow empty string: False <br>$minValue: 1800 <br>$maxValue: 86400 <br> |
