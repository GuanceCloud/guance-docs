...
| max | 统计最大值，需选择聚合的字段 |
| min | 统计最小值，需选择聚合的字段 |
| P75 | 统计指定字段75%!!(MISSING)的(MISSING)值，需选择聚合的字段 |
| P95 | 统计指定字段95%!!(MISSING)的(MISSING)值，需选择聚合的字段 |
| P99 | 统计指定字段99%!!(MISSING)的(MISSING)值，需选择聚合的字段 |
