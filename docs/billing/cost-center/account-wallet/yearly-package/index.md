...
在观测云费用中心，一个账号可同时绑定多个工作空间进行包年套餐费用统计，超出套餐部分按照[按量付费](../../../../billing/billing-method/index.md)进行统计，仅支持[观测云企业账号结算](../../../../billing/billing-account/enterprise-account.md)一种结算方式。
