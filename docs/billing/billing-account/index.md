...
2、在阿里云云市场购买“观测云专属版”，创建工作空间后，对应的工作空间结算方式不支持在管理后台调整 "任意结算方式升级"，原则上 SLS 存储的工作空间仅支持阿里云账号结算模式，不支持更改其他的结算方式。

3、若您选择阿里云账号结算，一旦释放或者过期或者删除，将自动将原来相关结算的工作空间进行冻结。观测云会进行相关邮件通知，邮件内容包括恢复办法。
