...
{{{ custom_key.brand_name }}} App 支持通过隔空接力，在移动端和电脑端同步查看数据，帮助您在必要的时候快速切换设备来处理问题。
...
>注意：{{{ custom_key.brand_name }}}移动端在「全部」事件/「我的」事件中仅为您提供 1000 条时间数据，如需查看更多时间，请前往网页端查看更多。 
