...
观测云提供体验版、商业版、私有云部署版三个版本。您可以在「付费计划与账单」查看您的观测云版本、[计费项](billing-method/index.md) 的使用情况，若您是商业版用户，您可以查看您结算账户的余额情况，为账户充值、更换结算方式、更换绑定邮箱，查看账单列表，您也可以在「付费计划与账单」进入观测云「[费用中心](cost-center/index.md)」查看更多账户详情。

> 注意：若您是观测云体验版用户，您可以在「付费计划与账单」升级为商业版用户，一经升级不可回退。

## 体验版

您可以 [注册观测云](https://auth.guance.com/businessRegister) 为体验版用户，注册完成后，在观测云工作空间「付费计划与账单」页面，您可以查看体验版各个计费项目每天的体验额度以及其使用情况，若需要 [升级到商业版](commercial-version.md) ，您可以点击「升级」按钮。
...
您可以 [注册观测云](https://auth.guance.com/businessRegister) 为商业版用户，注册完成后，在观测云工作空间「付费计划与账单」页面，您可以查看您结算账户的余额情况，为账户充值、更换结算方式、更换绑定邮箱，查看账单列表、使用统计视图等，您也可以进入「[费用中心](cost-center/index.md)」查看更多账户详情。
