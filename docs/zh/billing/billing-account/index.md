...
观测云企业账号结算是指直接在观测云 [费用中心](../../billing/cost-center/index.md) 进行充值结算，一个企业账号可以关联多个工作空间进行费用结算。
...
关于如何开通华为云储值卡结算方式，可参考文档 [华为云账号结算](../../billing/billing-account/huaweicloud-account.md) 。
