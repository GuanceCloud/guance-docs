...
阿里云账号是指直接通过阿里云账号进行充值结算，一个阿里云账号支持关联多个工作空间、多个站点的工作空间进行费用结算。本文将介绍观测云商业版如何开通阿里云账号结算。关于如何开通商业版，可参考文档 [注册商业版](../../billing/commercial-register.md) 。

## 选择阿里云账号结算

在注册或者升级观测云商业版时，您可以选择“阿里云账号结算”，或者您也可以在观测云工作空间「付费计划与账单」，点击「进入费用中心」-「工作空间管理」，点击“更改结算方式”，在弹出的对话框，选择“阿里云账号结算”。

![](../img/7.biling_account_9.png)

## 在阿里云市场开通观测云

在“更改结算方式”页面，点击“前往阿里云免费开通观测云服务”。在阿里云心选平台，点击“立即开通”。
...
在更改结算方式对话框，输入 [阿里用户 ID](#uid) 和 [商品实例 ID](#entity-id) ，点击“确定”，即可开通阿里云账户结算方式。

**注意**：使用阿里云账号结算方式可支持两种数据存储方案，在一键注册观测云商业版或在阿里云云市场购买观测云商业版时可以进行选择，更多详情可参考文档 [选择存储方式](../commercial-register#storage) 。
