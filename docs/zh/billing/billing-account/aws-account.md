...
在观测云工作空间「付费计划与账单」，点击「费用中心」-「工作空间管理」，选择需要更改为AWS账号结算的工作空间，点击“更改结算方式”。

![](../img/15.aws_register_9.png)

在弹出的对话框，选择“AWS账号结算”，并点击“ [前往亚马逊云市场订阅](#subscribe)”。
...
您可以在 [观测云费用中心](https://boss.guance.com/#/signin) ，「工作空间管理」查看更改已开通的结算方式。
