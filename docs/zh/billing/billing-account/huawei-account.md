...
## 首次注册<<< custom_key.brand_name >>>商业版时选择
...
登录进入[华为云云商店 > <<< custom_key.brand_name >>> SaaS 版](https://marketplace.huaweicloud.com/contents/8990a122-f456-43a4-892c-a458be31e336#productid=OFFI845592654693900288)商品购买页面。
...
3. 选择工作空间，点击右侧的更改按钮；
4. 选择**华为云账号结算**；
5. 首先[前往华为云开通](#market)<<< custom_key.brand_name >>>服务；
...
## 在华为云取消订阅<<< custom_key.brand_name >>> {#cancel}

1. 登录进入华为云商店 > 已购买的服务；
2. 点击该资源右侧**更多 > 关闭资源**；
3. 继续点击**关闭资源**；
4. 刷新当前页面，可看到该资源已经是**已关闭**的状态，说明已经在华为云取消订阅<<< custom_key.brand_name >>>。
...
**注意**：在华为云取消订阅<<< custom_key.brand_name >>>服务后，在<<< custom_key.brand_name >>>费用中心绑定该账号结算的所有工作空间，将删除关联的云账号，并锁定对应的工作空间，您可以解锁工作空间，工作空间解锁后，默认为<<< custom_key.brand_name >>>费用中心账号结算。
...
在 [华为云市场](https://marketplace.huaweicloud.com/contents/181f3d92-f40b-48d7-8ad5-420df0a682d2) 购买<<< custom_key.brand_name >>>预购卡后，您可以在我的订单查看购买的预购卡订单号，如下图所示。复制该订单号，填入<<< custom_key.brand_name >>>费用中购买预购卡对话框的**订单编号**。
