...
- 默认存储：使用 ElasticSearch 存储日志类数据，InfluxDB / TDengine 存储指标类数据；开通方式可参考文档 [阿里云市场开通观测云商业版](../../billing/commercial-aliyun.md)
- SLS 存储：使用 Log Store 存储日志类数据，Metric Store 存储指标类数据；开通方式可参考文档 [阿里云市场开通观测云专属版](../../billing/commercial-aliyun-sls.md)
