...
| 单价(每千条)   | <font color=coral>**CN**</font> | ￥ 0.6     | ￥ 0.7 | ￥ 0.8  |  ￥ 1  |    ￥ 4    |    ￥ 7    |
|    | <font color=coral>**CN（海外）**</font> | ￥ 1.6     | ￥ 1.8 | ￥ 2.2  |  ￥ 2.4  |    ￥ 8    |    ￥ 14    |
...
| 单价(每百万条)   |  <font color=coral>**CN**</font>| ￥ 1        |   ￥ 1.2 | ￥ 1.5  | ￥ 2  | ￥ 2.5   |
|    |  <font color=coral>**CN（海外）**</font>| ￥ 2        |   ￥ 2.4 | ￥ 3 | ￥ 4  | ￥ 5   |
...
| **全量统计**   |  |   |
| -------- | ---------- | ---------- |
| 单价(每 GB)   |  <font color=coral>**CN**</font>   | ￥ 0.007 |
|   |  <font color=coral>**CN（海外）**</font>   | ￥ 0.014 |
...
| **增量统计**   |  |   |
| -------- | ---------- | ---------- |
| 单价(每台主机)   | <font color=coral>**CN**</font> |  ￥ 2 |
|    | <font color=coral>**CN（海外）**</font> |  ￥ 4 |
|    | <font color=coral>**CN（海外）**</font> |  $ 0.6 |
...
| -------- | ---------- | -------- | ---------- |
| 数据存储策略 |     |3 天         | 7 天   | 14 天  |
| 单价(每百万个)   |  <font color=coral>**CN**</font>       | ￥ 2 |  ￥ 3  |  ￥ 6|
|   |  <font color=coral>**CN（海外）**</font>       | ￥ 6 |  ￥ 10  |  ￥ 20|
...
| -------- | ---------- | -------- | ---------- | ---------- |
| 数据存储策略 |     |3 天         | 7 天   | 14 天  |
| 单价(每万条)   |<font color=coral>**CN**</font> |￥0.2 |  ￥ 0.3  |  ￥ 0.5|
|    |<font color=coral>**CN（海外）**</font> |￥0.4 |  ￥ 0.6  |  ￥ 1|
...
| -------- | ---------- | -------- | ---------- | ---------- |
| 数据存储策略 |     |3 天         | 7 天   | 14 天  |
| 单价(每万个)   | <font color=coral>**CN**</font> | ￥ 0.7 | ￥ 1  |  ￥ 2|
|    | <font color=coral>**CN（海外）**</font> | ￥ 2 | ￥ 3  |  ￥ 5|
...
| **增量统计**   |  |    |
|-------- | ---------- |---------- |
| 单价(每千个)   |  <font color=coral>**CN**</font>   | ￥ 10 |
|    |  <font color=coral>**CN（海外）**</font>   | ￥ 15.4 |
...
| **增量统计**   |  |    |
|-------- | ---------- |---------- |
| 单价(每万次)   |  <font color=coral>**CN**</font>  | ￥ 1 |
|    |  <font color=coral>**CN（海外）**</font>  | ￥ 10 |
...
| **增量统计**   |  |   |
|-------- | ---------- |---------- |
| 单价(每 10 次)   | <font color=coral>**CN**</font>   |  ￥ 1 |
