...
???+ quote "更新日志"
    ...
    **2023.8.24**
    ...
    - [应用性能 Trace](#trace)、[用户访问 PV](#pv) 新增 30天/60天的数据存储策略。
...
=== "中国站点"
    ...
    | -------- | ---------- | ---------- | ---------- | ---------- | ---------- | ---------- |
    | 国内站点   | ￥ 0.6     | ￥ 0.7 | ￥ 0.8  |  ￥ 1  |    ￥ 4    |    ￥ 7    |

=== "海外站点"

    | 数据存储策略 |3 天         | 7 天   | 14 天  | 30 天 |     180 天   |    360 天     |
    | -------- | ---------- | ---------- | ---------- | ---------- | ---------- | ---------- |
    |  国际站点 | ￥ 1.6     | ￥ 1.8 | ￥ 2.2  |  ￥ 2.4  |    ￥ 8    |    ￥ 14    |
...
=== "中国站点"
    ...
    | 数据存储策略 |3 天         | 7 天   | 14 天  | 30 天 |     180 天   |    360 天     |
    | -------- | ---------- | ---------- | ---------- | ---------- | ---------- | ---------- |
    | 国内站点   | $ 0.09        | $ 0.1 | $ 0.12  |  $ 0.14  |    $ 0.58   |    $ 1   |

=== "海外站点"

    | 数据存储策略 |3 天         | 7 天   | 14 天  | 30 天 |     180 天   |    360 天     |
    | -------- | ---------- | ---------- | ---------- | ---------- | ---------- | ---------- |
    |  国际站点 | $ 0.23        | $ 0.26 | $ 0.32  |  $ 0.35  |    $ 1.2   |    $ 2   |
---
...
#### :material-numeric-1-circle-outline: 按数据条数计费
...
=== "中国站点"
    ...
    | 数据存储策略 |3 天         | 7 天   | 14 天  | 30 天 | 60 天  |
    | -------- | ---------- | ---------- | ---------- | ---------- | ---------- |
    | 国内站点   | $ 0.15       |   $ 0.17 | $ 0.22  | $ 0.28  | $ 0.36   |

=== "海外站点"

    | 数据存储策略 |3 天         | 7 天   | 14 天  | 30 天 | 60 天  |
    | -------- | ---------- | ---------- | ---------- | ---------- | ---------- |
    |  国际站点 | $ 0.3        |   $ 0.4 | $ 0.5  | $ 0.6  | $ 0.8   |
---
...
=== "中国站点"
    ...
    | 数据存储策略 |3 天         | 7 天   | 14 天  | 30 天 |    60 天   |
    | -------- | ---------- | ---------- | ---------- | ---------- | ---------- |
    | 国内站点   | ￥ 0.6     | ￥ 0.85 | ￥ 1 |  ￥ 1.2  |    ￥ 1.5    |

=== "海外站点"

    | 数据存储策略 |3 天         | 7 天   | 14 天  | 30 天 |    60 天   |
    | -------- | ---------- | ---------- | ---------- | ---------- | ---------- |
    |  国际站点 | ￥ 1.4     | ￥ 2.1 | ￥ 2.8  |  ￥ 3.08  |    ￥ 3.36    |
...
=== "中国站点"
    ...
    | 数据存储策略 |3 天         | 7 天   | 14 天  | 30 天 |    60 天   |
    | -------- | ---------- | ---------- | ---------- | ---------- | ---------- |
    | 国内站点   | $ 0.1        | $ 0.15 | $ 0.2  |  $ 0.22  |    $ 0.24   |

=== "海外站点"

    | 数据存储策略 |3 天         | 7 天   | 14 天  | 30 天 |    60 天   |
    | -------- | ---------- | ---------- | ---------- | ---------- | ---------- |
    |  国际站点 | $ 0.2        | $ 0.3 | $ 0.4  |  $ 0.44  |    $ 0.48   |
---

### 数据转发 {#backup}

基于当前工作空间不同的数据转发外部存档类型统计汇总转发的流量大小，并根据数据对应计费出账。（每 GB / 天）。
...
=== "中国站点"
    ...
    | 数据存储策略 |3 天         | 7 天   | 14 天  | 30 天   | 60 天  |
    | -------- | ---------- | ---------- | ---------- | ---------- | ---------- |
    | 国内站点   | $ 0.29 |  $ 0.43 |  $ 0.86 |  $ 2.58 |  $ 8.58 |

=== "海外站点"

    | 数据存储策略 |3 天         | 7 天   | 14 天  | 30 天   | 60 天  |
    | -------- | ---------- | ---------- | ---------- | ---------- | ---------- |
    |  国际站点 | $ 0.9 |  $ 1.4 |  $ 2.8 |   $ 8.4 |  $ 28 |
---
...
=== "中国站点"
    ...
    | 数据存储策略 |3 天         | 7 天   | 14 天  | 30 天   | 60 天  |
    | -------- | ---------- | ---------- | ---------- | ---------- | ---------- |
    | 国内站点   | $ 0.1 | $ 0.14  |  $ 0.29| $ 0.87  |  $ 2.9|

=== "海外站点"

    | 数据存储策略 |3 天         | 7 天   | 14 天  | 30 天   | 60 天  |
    | -------- | ---------- | ---------- | ---------- | ---------- | ---------- |
    |  国际站点 | $ 0.29 | $ 0.43  |  $ 0.71|  $ 2.13|  $ 7.1|
---
