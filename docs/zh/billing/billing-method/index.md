...
| 单价(每千条)   | <font color=coral>**国内版定价**</font> | ￥ 0.6     | ￥ 0.7 | ￥ 0.8  |  ￥ 1  |    ￥ 4    |    ￥ 7    |
| 单价(每千条)   | <font color=coral>**海外版定价**</font> | $ 0.23        | $ 0.26 | $ 0.32  |  $ 0.35  |    $ 1.2   |    $ 2   |
...
| 单价(每百万条)   |  <font color=coral>**国内版定价**</font>| ￥ 1        |   ￥ 1.2 | ￥ 1.5  | ￥ 2  | ￥ 2.5   |
| 单价(每百万条)   |  <font color=coral>**海外版定价**</font>| $ 0.3        |   $ 0.4 | $ 0.5  | $ 0.6  | $ 0.8   |
...
| **全量统计**   |  |   |
| -------- | ---------- | ---------- |
| 单价(每 GB)   |  <font color=coral>**国内版定价**</font>   | ￥ 0.007 |
...
| **增量统计**   |  |   |
| -------- | ---------- | ---------- |
| 单价(每台主机)   | <font color=coral>**国内版定价**</font> |  ￥ 2 |
...
| -------- | ---------- | -------- | ---------- |
| 数据存储策略 |     |3 天         | 7 天   | 14 天  |
| 单价(每百万个)   |  <font color=coral>**国内版定价**</font>       | ￥ 2 |  ￥ 3  |  ￥ 6|
| 单价(每百万个)   |  <font color=coral>**海外版定价**</font>       | $ 0.9 |  $ 1.4 |  $ 2.8|
...
| -------- | ---------- | -------- | ---------- | ---------- |
| 数据存储策略 |     |3 天         | 7 天   | 14 天  |
| 单价(每万条)   |<font color=coral>**国内版定价**</font> |￥0.2 |  ￥ 0.3  |  ￥ 0.5|
| 单价(每万条)   |<font color=coral>**海外版定价**</font> |$ 0.06 |  $ 0.09  |  $ 0.14|
...
| -------- | ---------- | -------- | ---------- | ---------- |
| 数据存储策略 |     |3 天         | 7 天   | 14 天  |
| 单价(每万个)   | <font color=coral>**国内版定价**</font> | ￥ 0.7 | ￥ 1  |  ￥ 2|
| 单价(每万个)   | <font color=coral>**海外版定价**</font> | $ 0.29 | $ 0.43  |  $ 0.71|
...
| **增量统计**   |  |    |
|-------- | ---------- |---------- |
| 单价(每千个)   |  <font color=coral>**国内版定价**</font>   | ￥ 10 |
| 单价(每千个)   |  <font color=coral>**海外版定价**</font>   | $ 2.2 |
...
| **增量统计**   |  |    |
|-------- | ---------- |---------- |
| 单价(每万次)   |  <font color=coral>**国内版定价**</font>  | ￥ 1 |
| 单价(每万次)   |   <font color=coral>**海外版定价**</font>  |  $ 1.43 |
...
|-------- | ---------- |---------- |
| 单价(每万次)   | <font color=coral>**国内版定价**</font>   |  ￥ 1 |
| 单价(每万次)   |  <font color=coral>**海外版定价**</font>  |  $ 0.3 |
...
| **增量统计**   |  |   |
|-------- | ---------- |---------- |
| 单价(每 10 次)   | <font color=coral>**国内版定价**</font>   |  ￥ 1 |
