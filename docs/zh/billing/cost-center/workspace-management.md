...
<font color=coral>**注意：**</font>工作空间的结算方式仅支持一个月更改一次。
...
> 更多详情可参考文档 [观测云费用中心账号结算](../../billing/billing-account/enterprise-account.md)。
...
<font color=coral>**注意：**</font>开启**结算方式任意选择**需要联系观测云客户经理在观测云计费平台会员管理进行更改。
