...
> 
> 若您需要在观测云开通 SLS 存储，可前往 [阿里云云市场开通观测云专属版](../billing/commercial-aliyun-sls.md)。
...
:material-numeric-1-circle-outline: [立即注册观测云商业版](#register)；

:material-numeric-2-circle-outline: [已有费用中心账号，去绑定](#bond)。
...
用户名：若您已经有观测云费用中心账号，可直接输入观测云费用中心账号用户名，通过邮箱验证进行绑定；
