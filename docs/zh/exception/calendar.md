...
已创建的日程可与[通知策略](./config-manag.md#notify-strategy)向上联动，并配合 Issue 通知的内容范围做进一步通知分配。
...
|   每个工作日（周一到周五）  | 以每个工作日范围为轮换单元。 |
|   每个非工作日（周六、周日）  | 以每个非工作日范围为轮换单元。 |
| 每周  | 以每周范围为轮换单元。 |
| 每月  | 以每月范围为轮换单元。 |
...
:material-numeric-5-circle-outline: 点击日程日历。可以日历的形式查看所有日程。点击标识，可直接查看其关联信息。hover 在通知对象、日程和通知策略上，可直接跳转至对应详情页面。
