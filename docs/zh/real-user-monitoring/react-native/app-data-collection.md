...
| `error_type` | string | 错误类型<br>logger error type: reactnative_crash &#124; java_crash &#124; native_crash &#124; anr_error &#124; anr_crash &#124; ios_crash<br>network error type：network_error |
