...
**1.创建 xcconfig 配置文件，在 .xcconfig 文件中配置变量**，可参考[向项目中添加构建配置文件](https://developer.apple.com/documentation/xcode/adding-a-build-configuration-file-to-your-project)。
...
找到 .dSYM 文件放在一个文件夹内，命令行下输入应用基本信息
