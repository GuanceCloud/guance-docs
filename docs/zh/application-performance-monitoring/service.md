...
链路数据采集到观测云后，您可以登录到观测云工作空间，点击**应用性能监测**的**服务**列表，查看选定时间范围内的所有链路服务列表及其对应的关键性能指标，包括平均请求数、平均响应时间、P75 响应时间、P95 响应时间、错误数，默认按照**错误数**降序排序。
...
- 点击 :material-wifi-arrow-up:，可将当前服务列表导出为 CSV。
- 点击 :fontawesome-solid-gear:，可自定义选择或隐藏当前列表的显示字段；
- 在特定**服务**行，点击右侧 :fontawesome-solid-palette:，可以修改颜色，修改后相关服务颜色均会同步改变；  
