...
<font color=coral>**注意：**</font>当您切换查看**服务**或**链路**查看器时，观测云默认为您保留当前的筛选条件和时间范围。
...
=== "关联主机"
    ...
    <font color=coral>**注意：**</font>观测云默认保存主机对象最近 48 小时的历史数据。未找到当前链路时间对应的主机历史数据时，您将无法查看关联主机的属性视图。
