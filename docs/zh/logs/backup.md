...
观测云商业版用户可使用日志备份功能，[体验版](../billing/trail.md)用户需先[升级商业版](../billing/commercial-version.md)。
...
- [<font color="coral"> :fontawesome-solid-arrow-right-long: &nbsp; 备份日志计费逻辑</font>](../billing/billing-method/billing-item.md#backup)
