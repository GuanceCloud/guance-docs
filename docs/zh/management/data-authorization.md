...
工作空间B（如：DataFlux）获得数据授权后，可以打开「场景」-「[仪表板](../scene/dashboard.md)或者「[笔记](../scene/note.md)」，选择图表组件，在“设置”的“工作空间”选择被授权查看的工作空间A（如：开发******），然后就可以通过[图表查询](../scene/visual-chart/chart-query.md)查看和分析被授权工作空间A（如：开发******）的数据。<br />![](img/9.dataauth_7.png)<br />**场景仪表板示例说明：**<br />上面三个有数据展示的图表是查询了被授权工作空间A（如：开发******）的数据；下面三个无数据展示的图表是查询当前工作空间B（如：DataFlux），由于该工作空间无数据，所以展示无数据。<br />![](img/9.dataauth_8.png)
