...
注意：在创建应用程序前，您需要先在 [Okta网站](https://www.okta.com/) 注册账号并创建您的组织。
...
2）在“Configure SAML”的“SAML Settings”部分，填入断言地址和Entity ID。
...
注意：此部分内容为必填项，如果不填，SSO单点登录时将提示无法登录。
...
1）返回 Okta，更新「 [步骤2](#step2) 」 中的“实体ID”和“断言地址”。
