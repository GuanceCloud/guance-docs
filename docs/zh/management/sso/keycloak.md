...
3）在“Clients”的“Mappers”，点击“Create”，创建邮箱映射，此部分内容为必填项，如果不填，无法实现SSO单点登录。
...
1）返回 Keycloak，更新「 [步骤2](#step2) 」 中的“实体ID”和“断言地址”。
...
2）输入“Username”和“Email”，Email为必填项，且需要和观测云身份提供商配置的用户百名单邮箱保持一致，用于匹配邮箱映射登录到观测云。
