...
在以任何方式加入工作空间之前，需要先[注册观测云账号](https://auth.guance.com/businessRegister)。[注册完成](../plans/commercial-huaweiyun.md)后，您可以通过[观测云官网](https://www.guance.com/)，点击**登录**，选择注册站点，输入登录账号和密码，登录到观测云控制台。系统会默认为您创建一个工作空间，并赋予**拥有者**权限。
