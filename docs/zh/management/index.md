...
若您 [费用中心](../billing/cost-center/index.md) 的账户余额已使用完毕，关联的工作空间将进入 14 天倒计时锁定状态：

- 14 天（含 14 天）内倒计时，工作空间锁定停用，新数据停止上报，用户可以关闭倒计时的弹出框，继续查看和分析历史数据，您可以通过点击「立即解锁」，在观测云费用中心解除锁定状态，解锁后可继续使用观测云。

![](img/9.workspace_lock_1.png)

- 14 天倒计时结束后，用户的数据被一键清除，无法继续使用观测云，您可以通过点击「立即解锁」，在观测云费用中心解除锁定状态，解锁后可继续使用观测云。
