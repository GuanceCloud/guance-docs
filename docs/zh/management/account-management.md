...
观测云默认显示“跟随浏览器时间”，支持选择“工作空间时区”。

在工作空间，点击左下角**账号 > 账号管理 > 时区**，即可修改当前的时区。您也可以在观测云提供的 [时间控件](../getting-started/function-details/explorer-search.md#time) 来快速修改时区。
...
进入**工作空间管理 > 设置 > 高级设置**，在**工作空间时区**，点击**设置**，即可统一配置时区。配置完成后，当工作空间的其他成员选定了**工作空间时区**，其时区状态会跟随配置好的空间时区变化而变化。
