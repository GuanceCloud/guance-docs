...
<img src="../img/3.space_management_6.png" width="60%" >
...
观测云支持为当前工作空间设置备注，备注仅自己可见，设置后将和工作空间名称同时显示，帮助您能更清晰地识别信息。
...
点击工作空间名称，您可查看所有工作空间及其备注。点击**设置备注**按钮即可添加或修改备注内容。
...
观测云支持拥有者和管理员删除指定资源目录分类以及所有资源目录，进入**管理 > 基本设置**，点击**删除资源目录**后，选择删除资源目录的方式，即可删除对应的对象数据。
