...
|                                | 成员管理               | 工作空间成员管理、SSO管理相关操作，包括<br/><li>团队管理（添加、删除、修改）<br/><li>邀请记录<br/><li>成员信息管理（删除、修改）<br/><li>角色管理（新建、删除、修改）<br/><li>批量修改权限<br/><li>SSO 管理<br/>&nbsp; &nbsp; - SSO 登录（启用、禁用、删除）<br/>&nbsp; &nbsp; - SAML 映射（新建、删除、修改、启用、禁用）<br/>&nbsp; &nbsp;- 自定义映射（新建、删除、修改） |
