...
点击**更多信息**，您可按需填写其他企业相关信息。

完成第二步，即**成功注册了观测云账号**。接下来的第三步将继续指导您**开通该账号下的工作空间**。
...
1. [**前往华为云免费开通**]([../billing/billing-account/huawei-account.md#market](https://marketplace.huaweicloud.com/contents/8990a122-f456-43a4-892c-a458be31e336#productid=OFFI845592654693900288))，购买观测云服务；
2. 输入工作空间名称；
3. 选择工作空间语言；
4. 输入华为云账号 ID；
5. 点击开通，完成注册。
...
1. [**前往阿里云免费开通观测云服务**](https://market.aliyun.com/products/56838014/cmgj00053362.html)，购买观测云服务；
2. 输入工作空间名称；
3. 选择工作空间语言；
4. 输入[**账号 ID**](../billing/billing-account/aliyun-account.md#uid)与[**商品实例 ID**](../billing/billing-account/aliyun-account.md#entity-id)；
5. 点击开通，完成注册。
...
在弹出的窗口，点击**前往微软云市场订阅**，订阅完成后点击**确定**即可完成注册。
