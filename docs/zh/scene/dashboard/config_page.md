...
除了查看当前仪表板的 ID、标识 ID、创建人、创建时间、更新人、更新时间以外，您还可在此处直接点击修改当前仪表板的名称、描述信息、标签、可视范围。
...
即{{{ custom_key.brand_name }}}将自动帮您收起左侧和顶部的导航栏，并全屏显示视图。点击 **ESC** 按钮，即可退出大屏模式。
...
{{{ custom_key.brand_name }}}会为您展示在近三个月内，该仪表板所作过的历史操作记录。
