...
- **UI 点击查询：**支持选择指标、基础对象、自定义对象、日志、应用性能、用户访问、安全巡检数据来源，通过直接在 UI 上点击选择查询变量，查询返回对应的数据值，不支持添加时间范围和配置级联查询；
- **自定义：**支持直接定义一组数值用于视图变量使用，无需通过查询语句获取相关值，不支持在添加时间范围和配置级联查询；
...
在 UI 点击查询中，支持选择指标、基础对象、自定义对象、日志、应用性能、用户访问、安全巡检数据来源，通过直接在 UI 上点击选择查询变量，查询返回对应的数据值。

在 UI 点击查询中，您无法添加时间范围和配置级联查询。
...
指标查询可用 [Show 函数](#show) 来查询数据，不支持添加时间范围筛选，说明如下：
...
基础设施查询可用 [DQL 语句查询](#dql) 来查询数据，支持在查询中添加时间范围筛选，说明如下：
...
自定义对象查询可用 [DQL 语句查询](#dql) 来查询数据，支持在查询中添加时间范围筛选，说明如下：
...
日志查询可用 [DQL 语句查询](#dql) 来查询数据，支持在查询中添加时间范围筛选，说明如下：
...
应用性能查询可用 [DQL 语句查询](#dql) 来查询数据，支持在查询中添加时间范围筛选，说明如下：
...
用户访问查询可用 [DQL 语句查询](#dql) 来查询数据，支持在查询中添加时间范围筛选，说明如下：
...
安全巡检查询可用 [DQL 语句查询](#dql) 来查询数据，支持在查询中添加时间范围筛选，说明如下：
