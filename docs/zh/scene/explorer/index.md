...
在查看器列表，点击右侧「操作」菜单下的「编辑」，选择「添加至菜单」，即可添加当前查看器至事件、基础设施、指标、日志、应用性能监测、用户访问监测、可用性监测、安全巡检、CI 可视化。

添加完成后，即可在对应的功能模块导航菜单，查看添加的自定义查看器。若您具有“场景配置管理”的权限，可跳转回场景编辑自定义查看器。更多权限管理可参考文档 [角色管理](../../management/role-management.md) 。
