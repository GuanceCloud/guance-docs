...
1.通过使用 kubernates 指标搭建场景仪表板，支持通过观测云自带的内置视图的[系统视图](../../scene/built-in-view/index.md)一键创建。

![](../img/3.contrainer_1.png)

2.通过使用 docker_containers 指标搭建场景仪表板，支持通过观测云自带的内置视图的[系统视图](../../scene/built-in-view/index.md)一键创建。
