...
| [Func](../dataflux-func/index.md) | Func 即 DataFlux Func，是观测云的扩展编程平台，可用于函数开发、管理和执行。简单易用、只需编写代码并发布，自动为函数生成 HTTP API 接口，官方内置各种开箱即用的脚本库，轻松供观测云调用。 |
