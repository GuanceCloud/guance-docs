...
| task | json | Y | 任务配置<br>允许为空: False <br>$maxDictLength: 65536 <br> |
| task.url | string |  | url<br>允许为空: False <br> |
| task.method | string |  | method<br>允许为空: False <br> |
| task.name | string | Y | 任务名称<br>允许为空: False <br>最大长度: 256 <br> |
