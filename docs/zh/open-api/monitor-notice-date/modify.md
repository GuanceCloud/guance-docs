...
<br />**POST /api/v1/monitor/notice/date/\{notice_date_uuid\}/modify**
...
## 请求例子
```shell
curl 'https://openapi.guance.com/api/v1/monitor/notice/date/ndate_302cd65724974557aa25f45dade30f00/modify' \
