...
| **ElasticSearch** &#124; **OpenSearch**  | 物理服务器&#124;虚拟机 | 4C16GB 1TB | 8C32G   2TB | 3 | ElasticSearch 版本：7.10+  OpenSearch 版本：2.3.0 **注：需要开启密码认证，安装匹配版本分词插件 analysis-ik** |
| **TDengine** &#124; **InfluxDB**  | 物理服务器&#124;虚拟机 | 4C8GB  500GB | 8C16GB 1TB | 1 | TDengine 版本：2.6+ InfluxDB 版本：1.7.8 |
