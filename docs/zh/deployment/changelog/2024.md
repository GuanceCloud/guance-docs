...
- AMD64 架构下载: https://static.<<< custom_key.brand_main_domain >>>/dataflux/package/guance-amd64-1.101.187.tar.gz
    - MD5: `0de09e506f59ff2b5761674137f365f9`

- ARM64 架构下载: https://static.<<< custom_key.brand_main_domain >>>/dataflux/package/guance-arm64-1.101.187.tar.gz
...
- AMD64 架构下载: https://static.<<< custom_key.brand_main_domain >>>/dataflux/package/guance-amd64-1.100.185.tar.gz
    - MD5: `711b90a43b1e0c5e944d7210cc2edbce`

- ARM64 架构下载: https://static.<<< custom_key.brand_main_domain >>>/dataflux/package/guance-arm64-1.100.185.tar.gz
    - MD5: `9fdc1001c8e90d380567bc74d6aec585`


### <<< custom_key.brand_name >>>部署版更新 {#onpremise1211}
...
- AMD64 架构下载: https://static.<<< custom_key.brand_main_domain >>>/dataflux/package/guance-amd64-1.99.184.tar.gz
    - MD5: `d7f759b7b25a1d50c721608f113588c7`

- ARM64 架构下载: https://static.<<< custom_key.brand_main_domain >>>/dataflux/package/guance-arm64-1.99.184.tar.gz
...
- AMD64 架构下载: https://static.<<< custom_key.brand_main_domain >>>/dataflux/package/guance-amd64-1.99.183.tar.gz
    - MD5: `ddc63b16e02ed8473740fe97983c7c35`

- ARM64 架构下载: https://static.<<< custom_key.brand_main_domain >>>/dataflux/package/guance-arm64-1.99.183.tar.gz
...
3. [静默时间](../../monitoring/mute-management.md)：定义“重复”静默时间时，支持自定义静默开始时间、静默持续时长，支持配置“按天”、“按周”、“按月”的静默周期，帮助更灵活地定义静默时间。同时新增静默计划预览功能，可以查看当前定义的静默时间。
...
- AMD64 架构下载: https://static.<<< custom_key.brand_main_domain >>>/dataflux/package/guance-amd64-1.98.182.tar.gz
    - MD5: `93a3c271e6395318b98aafc14f668289`

- ARM64 架构下载: https://static.<<< custom_key.brand_main_domain >>>/dataflux/package/guance-arm64-1.98.182.tar.gz
...
- AMD64 架构下载: https://static.<<< custom_key.brand_main_domain >>>/dataflux/package/guance-amd64-1.98.181.tar.gz
    - MD5: `2ebf51ebd9e2ac8d5ff30ac3e626f597`

- ARM64 架构下载: https://static.<<< custom_key.brand_main_domain >>>/dataflux/package/guance-arm64-1.98.181.tar.gz
...
- AMD64 架构下载: https://static.<<< custom_key.brand_main_domain >>>/dataflux/package/guance-amd64-1.97.180.tar.gz
    - MD5: `0a6a2bf00fbef5fb29fd2b6bbf544880`

- ARM64 架构下载: https://static.<<< custom_key.brand_main_domain >>>/dataflux/package/guance-arm64-1.97.180.tar.gz
...
- AMD64 架构下载: https://static.<<< custom_key.brand_main_domain >>>/dataflux/package/guance-amd64-1.97.179.tar.gz
    - MD5: `160fe9a8e9566221149a4a52ff4b0c2b`

- ARM64 架构下载: https://static.<<< custom_key.brand_main_domain >>>/dataflux/package/guance-arm64-1.97.179.tar.gz
...
3. [通知对象](../../monitoring/notify-target.md)列表：
    - 新增搜索、快捷筛选功能，支持快速检索通知对象；
    - 针对连续两天发送失败被系统禁用的通知对象，名称后展示标记。

4. [静默规则](../../monitoring/mute-management.md)优化：
...
- AMD64 架构下载: https://static.<<< custom_key.brand_main_domain >>>/dataflux/package/guance-amd64-1.96.178.tar.gz
    - MD5: `e7fb67ced822ca02ba4ede7220659d72`

- ARM64 架构下载: https://static.<<< custom_key.brand_main_domain >>>/dataflux/package/guance-arm64-1.96.178.tar.gz
...
- AMD64 架构下载: https://static.<<< custom_key.brand_main_domain >>>/dataflux/package/guance-amd64-1.95.177.tar.gz
    - MD5: `a288172615e91267406fcda748f38e12`

- ARM64 架构下载: https://static.<<< custom_key.brand_main_domain >>>/dataflux/package/guance-arm64-1.95.177.tar.gz
...
- 监控：
    - 通知对象管理：配置 [Webhook 通知对象](../../monitoring/notify-target.md#custom-webhook)，支持追加成员信息。
...
> **注： 此版本依赖 GuanceDB v1.8.1 版本，升级前请先升级 GuanceDB for metrics 和 GuanceDB for logs 引擎到 [v1.8.1](https://static.<<< custom_key.brand_main_domain >>>/guancedb/guancedb-cluster-linux-amd64-v1.8.1.tar.gz) 或以上版本。**
...
- 监控
    - 通知对象管理：新增[权限控制](../../monitoring/notify-target.md#permission)。配置操作权限后，仅被赋予权限的对象可对此通知对象进行编辑、删除操作。
...
> **注： 此版本依赖 GuanceDB-Logs v1.6.1 版本，升级前请先升级 GuanceDB-Logs 引擎到 [v1.6.1](https://static.<<< custom_key.brand_main_domain >>>/guancedb/guancedb-cluster-linux-amd64-v1.6.1.tar.gz) 或以上版本。**
...
- 监控 
    ...
    - [静默管理](../../monitoring/mute-management.md)：新增【附加信息】功能，支持针对静默规则添加解释说明，从而标识静默的原因或者来源等信息。
...
- 监控 > [静默管理](../../monitoring/mute-management.md)：静默规则列表页展示优化：支持列出当前工作空间所有静默规则，可通过快捷筛选快速过滤列出目标规则。
...
- 修复安装程序（Launcher）在全新部署<<< custom_key.brand_name >>>时，可能碰到的 Kubernetes Secret 创建失败的问题
- 修复一些其他小 Bug
