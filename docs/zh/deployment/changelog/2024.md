...
- AMD64 架构下载: https://{{{ custom_key.static_domain }}}/dataflux/package/guance-amd64-1.101.187.tar.gz
    - MD5: `0de09e506f59ff2b5761674137f365f9`

- ARM64 架构下载: https://{{{ custom_key.static_domain }}}/dataflux/package/guance-arm64-1.101.187.tar.gz
...
- AMD64 架构下载: https://{{{ custom_key.static_domain }}}/dataflux/package/guance-amd64-1.100.185.tar.gz
    - MD5: `711b90a43b1e0c5e944d7210cc2edbce`

- ARM64 架构下载: https://{{{ custom_key.static_domain }}}/dataflux/package/guance-arm64-1.100.185.tar.gz
...
- AMD64 架构下载: https://{{{ custom_key.static_domain }}}/dataflux/package/guance-amd64-1.99.184.tar.gz
    - MD5: `d7f759b7b25a1d50c721608f113588c7`

- ARM64 架构下载: https://{{{ custom_key.static_domain }}}/dataflux/package/guance-arm64-1.99.184.tar.gz
...
- AMD64 架构下载: https://{{{ custom_key.static_domain }}}/dataflux/package/guance-amd64-1.99.183.tar.gz
    - MD5: `ddc63b16e02ed8473740fe97983c7c35`

- ARM64 架构下载: https://{{{ custom_key.static_domain }}}/dataflux/package/guance-arm64-1.99.183.tar.gz
...
- AMD64 架构下载: https://{{{ custom_key.static_domain }}}/dataflux/package/guance-amd64-1.98.182.tar.gz
    - MD5: `93a3c271e6395318b98aafc14f668289`

- ARM64 架构下载: https://{{{ custom_key.static_domain }}}/dataflux/package/guance-arm64-1.98.182.tar.gz
...
- AMD64 架构下载: https://{{{ custom_key.static_domain }}}/dataflux/package/guance-amd64-1.98.181.tar.gz
    - MD5: `2ebf51ebd9e2ac8d5ff30ac3e626f597`

- ARM64 架构下载: https://{{{ custom_key.static_domain }}}/dataflux/package/guance-arm64-1.98.181.tar.gz
...
- AMD64 架构下载: https://{{{ custom_key.static_domain }}}/dataflux/package/guance-amd64-1.97.180.tar.gz
    - MD5: `0a6a2bf00fbef5fb29fd2b6bbf544880`

- ARM64 架构下载: https://{{{ custom_key.static_domain }}}/dataflux/package/guance-arm64-1.97.180.tar.gz
...
- AMD64 架构下载: https://{{{ custom_key.static_domain }}}/dataflux/package/guance-amd64-1.97.179.tar.gz
    - MD5: `160fe9a8e9566221149a4a52ff4b0c2b`

- ARM64 架构下载: https://{{{ custom_key.static_domain }}}/dataflux/package/guance-arm64-1.97.179.tar.gz
...
- AMD64 架构下载: https://{{{ custom_key.static_domain }}}/dataflux/package/guance-amd64-1.96.178.tar.gz
    - MD5: `e7fb67ced822ca02ba4ede7220659d72`

- ARM64 架构下载: https://{{{ custom_key.static_domain }}}/dataflux/package/guance-arm64-1.96.178.tar.gz
...
- AMD64 架构下载: https://{{{ custom_key.static_domain }}}/dataflux/package/guance-amd64-1.95.177.tar.gz
    - MD5: `a288172615e91267406fcda748f38e12`

- ARM64 架构下载: https://{{{ custom_key.static_domain }}}/dataflux/package/guance-arm64-1.95.177.tar.gz
...
> **注： 此版本依赖 GuanceDB v1.8.1 版本，升级前请先升级 GuanceDB for metrics 和 GuanceDB for logs 引擎到 [v1.8.1](https://{{{ custom_key.static_domain }}}/guancedb/guancedb-cluster-linux-amd64-v1.8.1.tar.gz) 或以上版本。**
...
> **注： 此版本依赖 GuanceDB-Logs v1.6.1 版本，升级前请先升级 GuanceDB-Logs 引擎到 [v1.6.1](https://{{{ custom_key.static_domain }}}/guancedb/guancedb-cluster-linux-amd64-v1.6.1.tar.gz) 或以上版本。**
