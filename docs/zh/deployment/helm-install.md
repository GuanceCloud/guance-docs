...
=== "Amd"
    ...
    ```shell
    wget https://df-storage-dev.oss-cn-hangzhou.aliyuncs.com/liwenjin/helm/helm-v3.8.0-linux-amd64.tar.gz && tar -xvf helm-v3.8.0-linux-amd64.tar.gz && mv linux-amd64/helm /bin
    ```
...
=== "Arm"
    ...
    ```shell
    wget https://df-storage-dev.oss-cn-hangzhou.aliyuncs.com/liwenjin/helm/helm-v3.10.2-linux-arm64.tar.gz && tar -xvf helm-v3.10.2-linux-arm64.tar.gz && mv linux-arm64/helm /bin
    ```
