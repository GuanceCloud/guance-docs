...
在监控器列表，您可以将已创建好的监控器保存为模版。根据这类模板，便于您快速编辑监控器配置条件，快速创建同类型监控器检测。
...
<img src="../img/monior-0725-2.png" width="60%" >

2、保存成功后，可前往**监控 > 新建 > 用户监控器模板**页面查看已保存为模板的监控器：

<img src="../img/monior-0725-1.png" width="80%" >

## 模板列表

:material-numeric-1-circle-outline: 在当前页面，支持根据左侧**检测库**、**创建人**、**更新人**进行条件筛选：

![](../img/custom-monitor.png)

:material-numeric-2-circle-outline: 点击监控器右侧头像，可查看该条监控器的创建人、创建时间、更新人、更新时间：
