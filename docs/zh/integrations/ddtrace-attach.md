...
-   [:material-language-java: :material-download:](https://{{{ custom_key.static_domain }}}/ddtrace/agent-attach-java.jar){:target="_blank"} ·
...
wget https://{{{ custom_key.static_domain }}}/ddtrace/dd-java-agent.jar
```
