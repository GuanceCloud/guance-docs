...
AWS ElastiCache Redis 指标展示，包括 CPU 使用率、连接数、缓存、网络流量等。

![image.png](../imgs/aws-elasticache-redis-1.png)

![image.png](../imgs/aws-elasticache-redis-2.png)

![image.png](../imgs/aws-elasticache-redis-3.png)

![image.png](../imgs/aws-elasticache-redis-4.png)

![image.png](../imgs/aws-elasticache-redis-5.png)
...
![image.png](../imgs/aws-elasticache-redis-13.png)
...
3、 创建 ID 为 ElastiCache 的脚本

![image.png](../imgs/aws-elasticache-redis-17.png)
...
import guance_aws_elasticache__main as aws_elasticache
...
def run():
    ...
    collectors = [
        aws_elasticache.DataCollector(account, elasticache_configs),
...
![image.png](../imgs/aws-elasticache-redis-20.png)

## 场景视图

<场景 - 新建仪表板 - 模板库 - 系统视图 - AWS ElastiCache Redis 监控视图>

## 指标详解

<[AWS ElactiCache Redis 指标列表](https://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/CacheMetrics.Redis.html)>
