...
腾讯云 MongoDB 内存版指标展示，包括连接数、磁盘使用率、请求次数、时延等。

![image](../imgs/tencent-mongodb-1.png)
...
![image](../imgs/tencent-mongodb-2.png)
...
![image](../imgs/tencent-mongodb-3.png)
...
import guance_tencentcloud_mongodb__main as tencentcloud_mongodb
...
def run():
    ...
    collectors = [
        tencentcloud_mongodb.DataCollector(account, mongodb_configs),
...
![image](../imgs/tencent-mongodb-4.png)



## 场景视图

<场景 - 新建仪表板 - 模板库 - 系统视图 - 腾讯云 MongoDB>

## 指标详解

<[腾讯云 MongoDB 指标列表](https://cloud.tencent.com/document/product/248/45104)>
