...
=== "x86_64 系统"
    ...
    ```shell
    wget https://{{{ custom_key.static_domain }}}/otn_software/instantclient/instantclient-basiclite-linux.x64-21.10.0.0.0dbru.zip \
...
=== "ARM64 系统"
    ...
    ```shell
    wget https://{{{ custom_key.static_domain }}}/otn_software/instantclient/instantclient-basiclite-linux.arm64-19.19.0.0.0dbru.zip \
        -O /usr/local/datakit/externals/instantclient-basiclite-linux.zip \
        && unzip /usr/local/datakit/externals/instantclient-basiclite-linux.zip -d /opt/oracle \
