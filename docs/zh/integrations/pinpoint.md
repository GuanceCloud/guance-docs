...
<figure markdown>
  ![OpenTracing](https://{{{ custom_key.static_domain }}}/images/datakit/datakit-opentracing.png){ width="600" }
...
<figure markdown>
  ![Pinpoint](https://{{{ custom_key.static_domain }}}/images/datakit/datakit-pinpoint.png){ width="600" }
