...
: - 数据处理后段 Pipeline 支持，你可以借助[{{{ custom_key.brand_name }}}提供的强大的 Pipeline 脚本](https://docs.guance.com/logs/pipelines/text-processing/){:target="_blank"}在数据发送到中心之前就对数据进行定制化。
