...
tags: 
  - AWS
summary: 'Amazon ECS 功能与 亚马逊云科技 Fargate 无服务器计算引擎集成，使用<<< custom_key.brand_name >>>监控其服务运行态。'
...
Amazon ECS 功能与 亚马逊云科技 `Fargate` 无服务器计算引擎集成，使用<<< custom_key.brand_name >>>监控其服务运行态。
...
6. 点击云帐号详情页的【集成】按钮，在`未安装`列表下，找到`AWS ECS`，点击【安装】按钮，弹出安装界面安装即可。


#### 手动开通脚本

1. 登陆Func 控制台，点击【脚本市场】，进入官方脚本市场，搜索:`guance_aws_ecs`
