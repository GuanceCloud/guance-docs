...
1. 在 DataFlux Func 上安装 GitLab CI 集成（脚本 ID：`guance_gitlab_ci`），安装流程参考[GitLab CI 集成配置](https://func.<<<custom_key.brand_domain>>>/doc/script-market-guance-gitlab-ci/){:target="_blank"};
