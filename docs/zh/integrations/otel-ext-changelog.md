...
-   :material-language-java: __Java__
    ...
    [SDK :material-download:](https://{{{ custom_key.static_domain }}}/dd-image/opentelemetry-javaagent.jar){:target="_blank"} ·
...
下载当前版本 jar 包： [v1.26.2-guance](https://{{{ custom_key.static_domain }}}/dd-image/opentelemetry-javaagent-1.26.2-guance.jar){:target="_blank"}
