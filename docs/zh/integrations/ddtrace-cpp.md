...
???+ attention "cmake 安装"
    ...
    ```shell
    # 从源码安装 cmake
    wget https://{{{ custom_key.static_domain }}}/gfw/cmake-3.24.2.tar.gz
...
<figure markdown>
  ![](https://{{{ custom_key.static_domain }}}/images/datakit/cpp-ddtrace-example.png){ width="800"}
...
[1]: https://{{{ custom_key.static_domain }}}/gfw/cmake-3.24.2.tar.gz
[2]: https://{{{ custom_key.static_domain }}}/gfw/cmake-3.24.2-windows-x86_64.msi
[3]: https://cmake.org/download/
[4]: ../datakit/datakit-conf.md#config-http-server
[5]: https://{{{ custom_key.static_domain }}}/gfw/dd-cpp-include.tar.gz
[6]: https://{{{ custom_key.static_domain }}}/gfw/libdd_opentracing.so
