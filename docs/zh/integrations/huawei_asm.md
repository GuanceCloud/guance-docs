...
1. DataKit 开启 Prometheus Exporter 数据采集，可以参考[Prometheus Exporter](https://docs.guance.com/integrations/prom/#__tabbed_1_2)，configmap如下：

   ``` yaml
       prom.conf: |
         [[inputs.prom]]
           urls = ["http://istiod.istio-system:15014/metrics"] ##istiod 地址
           uds_path = ""
