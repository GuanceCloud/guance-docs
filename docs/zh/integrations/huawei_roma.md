...
采集华为云 ROMA 指标数据 , 可以通过配置的方式采集更多的指标 [华为云 ROMA 指标详情](https://support.huaweicloud.com/usermanual-roma/roma_03_0023.html#section4){:target="_blank"}
...
采集到的华为云 ROMA 对象数据结构, 可以从「基础设施-资源目录」里看到对象数据
