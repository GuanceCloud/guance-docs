...
- [通过 Zip 创建层](https://docs.aws.amazon.com/zh_cn/lambda/latest/dg/creating-deleting-layers.html#layers-create){:target="_blank"}
    ...
    - zip 下载地址：
        - [Linux amd64](https://{{{ custom_key.static_domain }}}/datakit/datakit_aws_extension-linux-amd64.zip)
        - [Linux arm64](https://{{{ custom_key.static_domain }}}/datakit/datakit_aws_extension-linux-arm64.zip)
