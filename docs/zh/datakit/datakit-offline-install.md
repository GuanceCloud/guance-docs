...
=== "Windows 32 位"
    ...
    - [`Datakit`](https://{{{ custom_key.static_domain }}}/datakit/datakit-windows-386-1.66.2.tar.gz){:target="_blank"}
    - [`Datakit-Lite`](https://{{{ custom_key.static_domain }}}/datakit/datakit_lite-windows-386-1.66.2.tar.gz){:target="_blank"}
...
=== "Windows 64 位"
    ...
    - [`Datakit`](https://{{{ custom_key.static_domain }}}/datakit/datakit-windows-amd64-1.66.2.tar.gz){:target="_blank"}
    - [`Datakit-Lite`](https://{{{ custom_key.static_domain }}}/datakit/datakit_lite-windows-amd64-1.66.2.tar.gz){:target="_blank"}
...
=== "Linux X86 32 位"
    ...
    - [`Datakit`](https://{{{ custom_key.static_domain }}}/datakit/datakit-linux-386-1.66.2.tar.gz){:target="_blank"}
    - [`Datakit-Lite`](https://{{{ custom_key.static_domain }}}/datakit/datakit_lite-linux-386-1.66.2.tar.gz){:target="_blank"}
...
=== "Linux X86 64 位"
    ...
    - [`Datakit`](https://{{{ custom_key.static_domain }}}/datakit/datakit-linux-amd64-1.66.2.tar.gz){:target="_blank"}
    - [`Datakit-Lite`](https://{{{ custom_key.static_domain }}}/datakit/datakit_lite-linux-amd64-1.66.2.tar.gz){:target="_blank"}
    - [`Upgrader`](https://{{{ custom_key.static_domain }}}/datakit/dk_upgrader-linux-amd64.tar.gz){:target="_blank"}
    - [`APM Auto Instrumentation`](https://{{{ custom_key.static_domain }}}/datakit/datakit-apm-inject-linux-amd64-1.66.2.tar.gz){:target="_blank"}

=== "Linux Arm 32 位"

    - [`Installer`](https://{{{ custom_key.static_domain }}}/datakit/installer-linux-arm){:target="_blank"}
    - [`Datakit`](https://{{{ custom_key.static_domain }}}/datakit/datakit-linux-arm-1.66.2.tar.gz){:target="_blank"}
    - [`Datakit-Lite`](https://{{{ custom_key.static_domain }}}/datakit/datakit_lite-linux-arm-1.66.2.tar.gz){:target="_blank"}
...
=== "Linux Arm 64 位"
    ...
    - [`Datakit`](https://{{{ custom_key.static_domain }}}/datakit/datakit-linux-arm64-1.66.2.tar.gz){:target="_blank"}
    - [`Datakit-Lite`](https://{{{ custom_key.static_domain }}}/datakit/datakit_lite-linux-arm64-1.66.2.tar.gz){:target="_blank"}
    - [`Upgrader`](https://{{{ custom_key.static_domain }}}/datakit/dk_upgrader-linux-arm64.tar.gz){:target="_blank"}
    - [`APM Auto Instrumentation`](https://{{{ custom_key.static_domain }}}/datakit/datakit-apm-inject-linux-arm64-1.66.2.tar.gz){:target="_blank"}
<!-- markdownlint-enable -->
...
> 如果是离线安装 lite 版本的 Datakit，需指定带 `_lite` 后缀的安装包，比如 `datakit_lite-linux-amd64-1.66.2.tar.gz`。
...
> 如果是离线升级 lite 版本的 Datakit，需指定带 `_lite` 后缀的安装包，比如 `datakit_lite-linux-amd64-1.66.2.tar.gz`。
...
wget -P /datakit https://{{{ custom_key.static_domain }}}/datakit/installer-linux-amd64-1.66.2
wget -P /datakit https://{{{ custom_key.static_domain }}}/datakit/datakit-linux-amd64-1.66.2.tar.gz
wget -P /datakit https://{{{ custom_key.static_domain }}}/datakit/datakit_lite-linux-amd64-1.66.2.tar.gz
wget -P /datakit https://{{{ custom_key.static_domain }}}/datakit/dk_upgrader-linux-amd64.tar.gz
wget -P /datakit https://{{{ custom_key.static_domain }}}/datakit/datakit-apm-inject-linux-amd64-1.66.2.tar.gz
...
???+ Attention
    ...
    Windows 下的 `Installer` 程序的下载链接需添加 **.exe** 后缀，如 [*https://{{{ custom_key.static_domain }}}/datakit/installer-windows-386-1.66.2.exe*](https://{{{ custom_key.static_domain }}}/datakit/installer-windows-386-1.66.2.exe) 和
    [*https://{{{ custom_key.static_domain }}}/datakit/installer-windows-amd64-1.66.2.exe*](https://{{{ custom_key.static_domain }}}/datakit/installer-windows-amd64-1.66.2.exe)。
<!-- markdownlint-enable -->
