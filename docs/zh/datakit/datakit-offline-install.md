...
=== "Windows 32 位"
    ...
    - [`Datakit-Lite`](https://static.guance.com/datakit/datakit_lite-windows-386-1.37.0.tar.gz){:target="_blank"}
...
=== "Windows 64 位"
    ...
    - [`Datakit-Lite`](https://static.guance.com/datakit/datakit_lite-windows-amd64-1.37.0.tar.gz){:target="_blank"}
...
=== "Linux X86 32 位"
    ...
    - [`Datakit-Lite`](https://static.guance.com/datakit/datakit_lite-linux-386-1.37.0.tar.gz){:target="_blank"}
...
=== "Linux X86 64 位"
    ...
    - [`Datakit-Lite`](https://static.guance.com/datakit/datakit_lite-linux-amd64-1.37.0.tar.gz){:target="_blank"}
...
=== "Linux Arm 32 位"
    ...
    - [`Datakit-Lite`](https://static.guance.com/datakit/datakit_lite-linux-arm-1.37.0.tar.gz){:target="_blank"}
...
=== "Linux Arm 64 位"
    ...
    - [`Datakit-Lite`](https://static.guance.com/datakit/datakit_lite-linux-arm64-1.37.0.tar.gz){:target="_blank"}
...
> 如果是离线安装 lite 版本的 Datakit，需指定带 `_lite` 后缀的安装包，比如 `datakit_lite-linux-amd64-1.37.0.tar.gz`。
...
> 如果是离线升级 lite 版本的 Datakit，需指定带 `_lite` 后缀的安装包，比如 `datakit_lite-linux-amd64-1.37.0.tar.gz`。
...
???+ Attention
    ...
    Windows 下的 `Installer` 程序的下载链接需添加 **.exe** 后缀，如 [*https://static.guance.com/datakit/installer-windows-386-1.37.0.exe*](https://static.guance.com/datakit/installer-windows-386-1.37.0.exe) 和
    [*https://static.guance.com/datakit/installer-windows-amd64-1.37.0.exe*](https://static.guance.com/datakit/installer-windows-amd64-1.37.0.exe)。
<!-- markdownlint-enable -->
