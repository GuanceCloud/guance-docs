...
???+ Attention
    ...
    Windows 下的 `Installer` 程序的下载链接需添加 **.exe** 后缀，如 [*https://static.guance.com/datakit/installer-windows-386-1.19.2.exe*](https://static.guance.com/datakit/installer-windows-386-1.19.2.exe) 和
    [*https://static.guance.com/datakit/installer-windows-amd64-1.19.2.exe*](https://static.guance.com/datakit/installer-windows-amd64-1.19.2.exe)。
<!-- markdownlint-enable -->
