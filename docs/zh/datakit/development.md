...
- 如果要将测试的指标发送到{{{ custom_key.brand_name }}}，添加一个 Dataway 地址以及对应工作空间的 token 即可，比如 `DATAWAY_URL="https://openway.guance.com/v1/write/logging?token=<YOUR-TOKEN>"`
...
<figure markdown>
  ![](https://{{{ custom_key.static_domain }}}/images/datakit/datakit-pprof-pdf.png){ width="800" }
</figure>
