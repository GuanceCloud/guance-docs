...
恢复事件包括<u>恢复、数据断档恢复、数据断档视为恢复、手动恢复</u>四种场景。见下表：
...
- [<font color="coral"> :fontawesome-solid-arrow-right-long: &nbsp; tongguoz通过告警统计图可视化分析事件数据</font>](../../scene/visual-chart/alert-statistics.md)
