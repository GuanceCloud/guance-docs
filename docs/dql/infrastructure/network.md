...
你需要先创建一个 [观测云账号](https://auth.guance.com/register?channel=语雀)，并在你的主机上 [安装 DataKit](https://www.yuque.com/dataflux/datakit/datakit-install)，开启 [eBPF 采集器](https://www.yuque.com/dataflux/datakit/ebpf)。

## 网络性能详情

### 主机

主机网络数据采集成功后会上报到观测云控制台，在「基础设施」-「主机」详情页中的「网络」，您可以查看到工作空间内全部网络性能监测数据信息。更多详情可参考 [主机网络](https://www.yuque.com/dataflux/doc/mwqbgr#PqtQj) 。
...
- 关联查询：您可以点击主机图标进行关联查询，支持查看网络详情、主机详情、关联日志、关联链路以及关联事件。
...
- 关联查询：你可以点击 Pod 图标进行关联查询，支持查看网络详情、 Pod 详情、关联日志、关联链路以及关联事件。
